...
public class MediaPlayer implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        return VisagePaletteUtilities.insertSnippet(MediaPlayer.class, "TEMPLATE_MediaPlayer", targetComponent, "visage.scene.media.Media", "visage.scene.media.MediaPlayer"); //NOI18N;
    }
}
