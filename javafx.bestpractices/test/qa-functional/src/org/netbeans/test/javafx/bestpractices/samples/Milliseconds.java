...
public class Milliseconds extends JavaFXTestCase {
    ...
    static String[] TESTS = {"testMillisecondsCreate", "testMillisecondsCompile", "testMillisecondsCloseProject"};
    ...
    public void testMillisecondsCreate() {
    ...
    public void testMillisecondsCompile() {
    ...
    public void testMillisecondsCloseProject() {
