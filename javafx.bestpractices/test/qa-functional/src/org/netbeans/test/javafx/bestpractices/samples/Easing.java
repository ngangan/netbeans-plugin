...
public class Easing extends JavaFXTestCase {
    ...
    public String _projectPath = "Easing|Source Packages|input|Easing.fx";
    static String[] TESTS = {"testEasingCreate", "testEasingCompile", "testEasingCloseProject"};
    ...
    public void testEasingCloseProject() {
    ...
    public static Test suite() {
        return NbModuleSuite.create(Easing.class, ".*", ".*", TESTS);
    }
}
