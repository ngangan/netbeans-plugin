...
public class SmokeParticleSystem extends JavaFXTestCase {

    public String _type = "Simulation"; //Type of Sample
    public String _project = "Smoke Particle System";
    public String _projectPath = "Smoke Particle System|Source Packages|particles|SmokeParticleSystem.fx";
    static String[] TESTS = {"testSmokeParticleSystemCreate", "testSmokeParticleSystemCompile", "testSmokeParticleSystemCloseProject"};
    
    public SmokeParticleSystem (String name) {
        super(name);
    }

    /** Create Sample Project and Verify that Project exists */
    public void testSmokeParticleSystemCreate() {
    ...
    public void testSmokeParticleSystemCompile() {
    ...
    public void testSmokeParticleSystemCloseProject() {
    ...
    public static Test suite() {
        return NbModuleSuite.create(SmokeParticleSystem.class, ".*", ".*", TESTS);
    }
}
