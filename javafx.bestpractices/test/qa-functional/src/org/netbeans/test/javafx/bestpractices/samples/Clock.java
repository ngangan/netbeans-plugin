...
public class Clock extends JavaFXTestCase {
    ...
    static String[] TESTS = {"testClockCreate", "testClockCompile", "testClockCloseProject"};
    ...
    public void testClockCloseProject() {
