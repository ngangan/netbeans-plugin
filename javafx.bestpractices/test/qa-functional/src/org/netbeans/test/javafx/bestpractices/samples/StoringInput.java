...
public class StoringInput extends JavaFXTestCase {
    ...
    static String[] TESTS = {"testStoringInputCreate", "testStoringInputCompile", "testStoringInputCloseProject"};
    ...
    public void testStoringInputCreate() {
    ...
    public void testStoringInputCompile() {
    ...
    public void testStoringInputCloseProject() {
