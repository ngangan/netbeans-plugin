...
public class Bounce extends JavaFXTestCase {
    ...
    static String[] TESTS = {"testBounceCreate", "testBounceCompile", "testBounceCloseProject"};
    ...
    public void testBounceCloseProject() {
