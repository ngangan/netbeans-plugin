...
public class Scale extends JavaFXTestCase {
    ...
    static String[] TESTS = {"testScaleCreate", "testScaleCompile", "testScaleCloseProject"};
    ...
    public void testScaleCloseProject() {
