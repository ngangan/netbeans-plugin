...
public class LinearGradient extends JavaFXTestCase {
    ...
    static String[] TESTS = {"testLinearGradientCreate", "testLinearGradientCompile", "testLinearGradientCloseProject"};
    ...
    public void testLinearGradientCreate() {
    ...
    public void testLinearGradientCloseProject() {
