...
public class ElementVisagedoc {
     ...
     * @return ElementVisagedoc describing the jaadoc
     */
    public static final ElementVisagedoc create(CompilationInfo compilationInfo, Element element) {
        return new ElementVisagedoc(compilationInfo, element, null);
    }
     ...
     * @return ElementVisagedoc describing the javadoc of liked element
     */
    public ElementVisagedoc resolveLink(final String link) {
        final ElementVisagedoc[] ret = new ElementVisagedoc[1];
        try {
            final ElementHandle<? extends Element> linkDoc = links.get(link);
            FileObject fo = linkDoc != null ? org.netbeans.api.visage.source.VisageSourceUtils.getFile(linkDoc, cpInfo) : null;
            if (fo != null && fo.isFolder() && linkDoc.getKind() == ElementKind.PACKAGE) {
                fo = fo.getFileObject("package-info", "visage"); //NOI18N
            }
...
//            VisageSource js = fo != null ? VisageSource.forFileObject(fo) : VisageSource.create(cpInfo);
                ...
                js.runUserActionTask(new Task<CompilationController>() {
                    public void run(CompilationController controller) throws IOException {
                        ...
                        if (linkDoc != null) {
                            ...
                            if (e != null) {
                                ret[0] = new ElementVisagedoc(controller, e, null);
                            }
                        } else {
                            ...
                            if (uri != null) {
                                ...
                                if (e != null) {
                                    ...
                                    ret[0] = new ElementVisagedoc(controller, e, new URL(docURL, link));
                                } else {
                                    //external URL
                                    if (uri.isAbsolute()) {
                                        ret[0] = new ElementVisagedoc(uri.toURL());
                                    }
                                }
                            }
                        }
    ...
    private ElementVisagedoc(CompilationInfo compilationInfo, Element element, URL url) {
        ...
        boolean isJavaClass = (doc != null) && doc.isClass() && !compilationInfo.getVisageTypes().isVisageClass((Symbol) element);
        boolean localized = false;
        if (element != null) {
            VisageSourceUtils.URLResult res = VisageSourceUtils.getJavadoc(element, compilationInfo);
            if (res != null) {
                docURL = res.url;
            ...
            if (!localized) {
                ...
                if (handle[0] != null) {
                    final FileObject fo = org.netbeans.api.visage.source.VisageSourceUtils.getFile(handle[0], cpInfo);
                    if (fo != null) {
    ...
    private ElementVisagedoc(URL url) {
        assert url != null;
        this.content = null;
        this.docURL = url;
    }
    ...
    private String prepareContent(ElementUtilities eu, Doc doc, final boolean useJavadoc, boolean isJavaClass) {
        ...
        if (doc != null) {
            ...
            if (jdText != null) {
                ...
                sb.append(NbBundle.getMessage(ElementVisagedoc.class, "javadoc_content_not_found")); //NOI18N
            }
            sb.append("</p>"); //NOI18N
            return sb.toString();
        }
...
//        }
        ...
        if (isJavaClass) {
            ...
            Type[] ifaces = cdoc.interfaceTypes();
            if (ifaces.length > 1) { // java visage multiple inheritance
                sb.append("\nextends "); //NOI18N
                for (int i = 0; i < ifaces.length; i++) {
                    appendType(eu, sb, ifaces[i], false, false);
                    if (i < ifaces.length - 1) {
    ...
    private CharSequence getMethodTags(ElementUtilities eu, MethodDoc doc, Tag[] returnTags, Map<Integer, List<Tag>> paramInlineTags,
        ...
        StringBuilder sb = new StringBuilder();
        if (par.length() > 0) {
            sb.append("<b>").append(NbBundle.getMessage(ElementVisagedoc.class, "JCD-params")).append("</b><blockquote>").append(par).append("</blockquote>"); //NOI18N
        }
        if (ret.length() > 0) {
            sb.append("<b>").append(NbBundle.getMessage(ElementVisagedoc.class, "JCD-returns")).append("</b><blockquote>").append(ret).append("</blockquote>"); //NOI18N
        }
        if (thr.length() > 0) {
            sb.append("<b>").append(NbBundle.getMessage(ElementVisagedoc.class, "JCD-throws")).append("</b><blockquote>").append(thr).append("</blockquote>"); //NOI18N
        }
        if (since != null) {
            sb.append("<b>").append(NbBundle.getMessage(ElementVisagedoc.class, "JCD-since")).append("</b><blockquote>").append(since).append("</blockquote>"); //NOI18N
        }
        int length = see.length();
        if (length > 0) {
            sb.append("<b>").append(NbBundle.getMessage(ElementVisagedoc.class, "JCD-see")).append("</b><blockquote>").append(see.delete(length - 2, length)).append("</blockquote>"); //NOI18N
        }
        return sb;
    }
    ...
    private CharSequence getDeprecatedTag(ElementUtilities eu, Doc doc) {
        ...
        for (Tag tag : doc.tags()) {
            if (DEPRECATED_TAG.equals(tag.kind())) {
                sb.append("<b>").append(NbBundle.getMessage(ElementVisagedoc.class, "JCD-deprecated")).append("</b> <i>").append(inlineTags(eu, doc, tag.inlineTags())).append("</i></p><p>"); //NOI18N
                break;
            }
        }
        return sb;
