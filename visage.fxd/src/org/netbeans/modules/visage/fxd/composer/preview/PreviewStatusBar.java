 ...
 * @author Pavel Benes
 */
 final class PreviewStatusBar extends JPanel {
    public static final int CELL_POSITION = 0;
    public static final int CELL_MODE     = 1;
    public static final int CELL_MAIN     = 2;
     
    public static final String LOCKED           = NbBundle.getMessage(PreviewStatusBar.class, "LBL_STATUS_BAR_LOCKED"); //NOI18N
    public static final String UNLOCKED         = NbBundle.getMessage(PreviewStatusBar.class, "LBL_STATUS_BAR_UNLOCKED"); //NOI18N
    public static final String TOOLTIP_LOCKED   = NbBundle.getMessage(PreviewStatusBar.class, "HINT_STATUS_BAR_LOCKED"); //NOI18N
    public static final String TOOLTIP_UNLOCKED = NbBundle.getMessage(PreviewStatusBar.class, "HINT_STATUS_BAR_UNLOCKED"); //NOI18N
       
    private static final String[] POS_MAX_STRINGS = new String[] { "-99999.9:-99999.9" }; // NOI18N
    
    private final Cell [] cells = new Cell[3];

    public PreviewStatusBar() {
