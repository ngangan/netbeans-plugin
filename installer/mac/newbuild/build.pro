...
<project name="Mac Installer Properties" basedir="." >
    ...
    <!-- JavaFX Properties -->
    <property name="javafx_location" value="${javafx_builds_host}/lastSuccessfulBuild/artifact/build/zips/javafx-cluster-mac.zip"/>
    <property name="javafx_sdk_location" value="${javafx_builds_host}/lastSuccessfulBuild/artifact/build/zips/javafx-sdk-mac.zip"/>
