 ...
 * @author answer
 */
public final class FXFileBuiltQueryImpl implements FileBuiltQueryImplementation, PropertyChangeListener {
    ...
    public FXFileBuiltQueryImpl(AntProjectHelper helper, PropertyEvaluator evaluator, SourceRoots sourceRoots,
    ...
    private FileBuiltQueryImplementation createDelegate() {
        ...
        for (int i = 0; i < tstRoots.length; i++) {
            ...
            from[2*srcRoots.length + tstRoots.length + i] = "${" + tstRoots[i] + "}/*.fx"; // NOI18N
