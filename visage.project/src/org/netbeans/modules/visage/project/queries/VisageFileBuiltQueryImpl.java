 ...
 * @author answer
 */
public final class VisageFileBuiltQueryImpl implements FileBuiltQueryImplementation, PropertyChangeListener {
    ...
    public VisageFileBuiltQueryImpl(AntProjectHelper helper, PropertyEvaluator evaluator, SourceRoots sourceRoots,
    ...
    private FileBuiltQueryImplementation createDelegate() {
        ...
        for (int i = 0; i < srcRoots.length; i++) {
            ...
            from[srcRoots.length + tstRoots.length + i] = "${" + srcRoots[i] + "}/*.visage"; // NOI18N
        ...
        for (int i = 0; i < tstRoots.length; i++) {
            ...
            from[2*srcRoots.length + tstRoots.length + i] = "${" + tstRoots[i] + "}/*.visage"; // NOI18N
            to[2*srcRoots.length + tstRoots.length + i] = "${build.test.classes.dir}/*.class"; // NOI18N
        }
