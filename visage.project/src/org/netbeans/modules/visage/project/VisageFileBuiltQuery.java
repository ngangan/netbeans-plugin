...
public class VisageFileBuiltQuery implements FileBuiltQueryImplementation, PropertyChangeListener {
    ...
    VisageFileBuiltQuery (AntProjectHelper helper, PropertyEvaluator evaluator,
    ...
    private FileBuiltQueryImplementation createDelegate () {
        ...
        for (int i=0; i< srcRoots.length; i++) {
            from[i] = "${" + srcRoots[i] + "}/*.visage"; // NOI18N
