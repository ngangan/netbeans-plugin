 ...
 * @author avk
 */
public class RootElemCompletionProvider extends AbstractCompletionProvider {

    private static final Logger LOG = Logger.getLogger(RootElemCompletionProvider.class.getName());
