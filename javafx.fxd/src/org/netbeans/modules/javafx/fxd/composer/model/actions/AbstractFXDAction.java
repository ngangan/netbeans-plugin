...
public abstract class AbstractFXDAction extends AbstractAction implements Presenter.Popup {
    ...
    public AbstractFXDAction(String name) {
        this(name, true);
    }

    public AbstractFXDAction(String name, boolean isEnabled) {
        this(name, isEnabled, 100);
    }
    
    public AbstractFXDAction(String name, boolean isEnabled, int toolBarPos) {
        m_name  = name;
    ...
    public static String getMessage(String msgId) {
        return NbBundle.getMessage(AbstractFXDAction.class, msgId);       
    }
