 ...
 * @author Pavel Benes
 */
public final class FXZDataLoader extends UniFileLoader {
    ...
    protected String defaultDisplayName() {
        return NbBundle.getMessage(FXZDataLoader.class, "LBL_FXZ_loader_name"); //NOI18N
    }
    ...
    protected MultiDataObject createMultiObject(FileObject primaryFile) throws DataObjectExistsException, IOException {
        return new FXZDataObject(primaryFile, this);
    }
