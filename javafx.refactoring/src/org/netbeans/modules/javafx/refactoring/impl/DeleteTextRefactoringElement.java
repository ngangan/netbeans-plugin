 ...
 */
public class DeleteTextRefactoringElement extends SimpleRefactoringElementImplementation {
    final private static Logger LOGGER = Logger.getLogger(DeleteTextRefactoringElement.class.getName());
    ...
    final public static DeleteTextRefactoringElement create(FileObject fo, int start, int end, Lookup context) {
        try {
            return new DeleteTextRefactoringElement(fo, start, end, context);
        } catch (IOException e) {
    ...
    private DeleteTextRefactoringElement(FileObject fo, int start, int end, Lookup context) throws IOException {
    ...
    public String getDisplayText() {
        try {
            ...
            newLine.replace(delta, delta + length, "");
    ...
    public PositionBounds getPosition() {
        return new PositionBounds(des.createPositionRef(startPosition, Bias.Forward), des.createPositionRef(endPosition, Bias.Forward));
    }
                ...
                public void run() {
                    try {
                        synchronized(doc) {
                            ...
                            tc.replaceText(startPosition, length, 0);
                        }
