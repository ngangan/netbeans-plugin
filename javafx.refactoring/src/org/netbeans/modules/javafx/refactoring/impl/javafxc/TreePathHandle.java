...
public final class TreePathHandle {
     ...
     */                                                                                                                                                                                                                        
    public JavaFXTreePath resolve (final CompilationInfo compilationInfo) throws IllegalArgumentException {
        final JavaFXTreePath result = this.delegate.resolve(compilationInfo);
        if (result == null) {
    ...
    /**                                                                                                                                                                                                                        
     * Returns the {@link Tree.JavaFXKind} of this TreePathHandle,
     ...
     */
    public static TreePathHandle create(final JavaFXTreePath treePath, CompilationInfo info) throws IllegalArgumentException {
        ...
        JavaFXTreePath current = treePath;
        Element element;
    ...
    public static TreePathHandle create(Element element, CompilationInfo info) throws IllegalArgumentException {
        ...
        if (element instanceof Symbol.ClassSymbol) {
            ...
            clsSym = (Symbol.ClassSymbol) ElementUtilities.enclosingTypeElement(element);
        }
        ...
        return new TreePathHandle(new ElementDelegate(ElementHandle.create(element), u, qualName, element.getSimpleName().toString(), info.getClasspathInfo()));
    }
    ...
    private static final class TreeDelegate implements Delegate {
        ...
        private final Tree.JavaFXKind kind;

        private TreeDelegate(PositionRef position, KindPath kindPath, FileObject file, ElementHandle element, String simpleName, boolean enclElIsCorrespondingEl) {
            ...
            if (kindPath != null) {
                ...
                if (enclElIsCorrespondingEl) {
                    ...
                    if (k.isClass() || k.isInterface()) {
                        kind = Tree.JavaFXKind.CLASS_DECLARATION;
                    } else if (k.isField()) {
                        kind = Tree.JavaFXKind.VARIABLE;
                    } else if (k == ElementKind.METHOD || k == ElementKind.CONSTRUCTOR) {
                        kind = Tree.JavaFXKind.FUNCTION_DEFINITION;
                    } else {
                        kind = null;
                    }
                } else {
        ...
        public JavaFXTreePath resolve(final CompilationInfo compilationInfo) throws IllegalArgumentException {
            ...
            JavaFXTreePath tp = null;
            if (element != null) {
                JavaFXTreePath startPath = compilationInfo.getTrees().getPath(element);
                if (startPath == null) {
            ...
            while (tp != null) {
                ...
                kindPath.getList().remove(Tree.JavaFXKind.ERRONEOUS);
    ...
    private static final class ElementDelegate implements Delegate {
        ...
        public ElementDelegate(ElementHandle<? extends Element> el, URL source, String qualName, String simpleName, ClasspathInfo cpInfo) {
            this.el = el;
            this.source = source;
        ...
        public FileObject getFileObject() {
            ...
            Set<FileObject> files = cpInfo.getClassIndex().getResources(el, EnumSet.of(ClassIndex.SearchKind.TYPE_DEFS), EnumSet.of(ClassIndex.SearchScope.SOURCE));
        ...
        public JavaFXTreePath resolve(CompilationInfo compilationInfo) throws IllegalArgumentException {
        ...
        @Override
        public int hashCode() {
            return Arrays.hashCode(el.getSignatures());
        }
