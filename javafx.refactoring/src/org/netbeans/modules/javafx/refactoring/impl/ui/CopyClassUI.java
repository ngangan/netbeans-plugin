 ...
 * @author Jan Becicka
 */
public class CopyClassUI implements RefactoringUI, RefactoringUIBypass {
    ...
    public CustomRefactoringPanel getPanel(ChangeListener parent) {
        if (panel == null) {
            ...
            panel = new CopyClassPanel(parent,
                    ...
                    SourceUtils.getPackageName(target),
                    target,
                    resource.getName());
    ...
    public String getDescription() {
        return NbBundle.getMessage(CopyClassUI.class, "DSC_CopyClass", refactoring.getNewName()); // NOI18N
    }

    public String getName() {
        return NbBundle.getMessage(CopyClassUI.class, "LBL_CopyClass"); // NOI18N
    }
    ...
    public HelpCtx getHelpCtx() {
        return new HelpCtx(CopyClassUI.class.getName());
    }
    ...
    public void doRefactoringBypass() throws IOException {
        ...
        FileObject target = SourceUtils.getOrCreateFolder(refactoring.getTarget().lookup(URL.class));
        if (source!=null) {
