...
public class RenameClass extends BaseRefactoringElementImplementation {
    private String oldName, newName;

    public RenameClass(FileObject srcFO, String oldName, String newName, RefactoringSession session) {
        super(srcFO, session);
    ...
    protected Set<Transformation> prepareTransformations(final CompilationController cc) {
        ...
        JavaFXTreePathScanner scanner = new JavaFXTreePathScanner() {
            ...
            public Object visitClassDeclaration(ClassDeclarationTree node, Object p) {
                if (oldName.equals(node.getSimpleName().toString())) {
