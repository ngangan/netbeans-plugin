 ...
 * @author cms
 */
public final class AddProfilingRootMethodAction extends NodeAction {
    //~ Constructors -------------------------------------------------------------------------------------------------------------

    public AddProfilingRootMethodAction() {
    ...
    public String getName() {
        return NbBundle.getMessage(AddProfilingRootMethodAction.class, "LBL_AddProfilingRootMethodAction"); // NOI18N
    }
