...
public abstract class TreeRuleTestBase extends NbTestCase {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        SourceUtilsTestUtil.prepareTest(new String[] {"org/netbeans/modules/javafx/dataloader/layer.xml"}, new Object[0]);
    ...
    protected void prepareTest(String fileName, String code) throws Exception {
        ...
        JavaFXSource js = JavaFXSource.forFileObject(data);
        
        assertNotNull(js);
        
        info = SourceUtilsTestUtil.getCompilationInfo(js, Phase.PARSED);
    ...
    protected abstract List<ErrorDescription> computeErrors(CompilationInfo info, JavaFXTreePath path);
    
    protected List<ErrorDescription> computeErrors(CompilationInfo info, JavaFXTreePath path, int offset) {
    ...
    protected void performAnalysisTest(String fileName, String code, int pos, String... golden) throws Exception {
        ...
        JavaFXTreePath path = info.getTreeUtilities().pathFor(pos);
