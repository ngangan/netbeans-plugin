 ...
 */
public class HintsTestBase extends JavaFXTestBase {
...
//        GlobalSourcePathTestUtil.setUseLibraries(false);
        ...
        Collection<ElementHandle<TypeElement>> options = ClassIndex.forClasspathInfo(cpInfo).getDeclaredTypes("Node", ClassIndex.NameKind.SIMPLE_NAME, SCOPE);
