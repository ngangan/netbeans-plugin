...
public class TemplateVar extends JavaFXTestCase {
    ...
    public static String GOLDEN = "goldenfiles/org/netbeans/test/javafx/editor/templates/TemplateVar.pass";
    protected static final String PROJECT_NAME = "TemplateVar";
    ...
    public static Test suite() {
        return NbModuleSuite.create(TemplateVar.class, ".*", ".*", TESTS);
    }
    ...
    public void testTemplate() {
        ...
        JEditorPaneOperator editor = Util.typeTemplateAtPlaceCodeHere(PROJECT_NAME, SAMPLE_PATH, "var");
