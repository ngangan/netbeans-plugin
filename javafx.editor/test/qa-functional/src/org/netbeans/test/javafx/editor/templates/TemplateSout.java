...
public class TemplateSout extends JavaFXTestCase {
    ...
    public static String GOLDEN = "goldenfiles/org/netbeans/test/javafx/editor/templates/TemplateSout.pass";
    protected static final String PROJECT_NAME = "TemplateSout";

    public TemplateSout(String name) {
        super(name);
    }

    public static Test suite() {
        return NbModuleSuite.create(TemplateSout.class, ".*", ".*", TESTS);
    }
    ...
    public void testTemplate() {
        ...
        JEditorPaneOperator editor = Util.typeTemplateAtPlaceCodeHere(PROJECT_NAME, SAMPLE_PATH, "sout");
