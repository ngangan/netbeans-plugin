...
public class TemplateTof extends JavaFXTestCase {
    ...
    public static String GOLDEN = "goldenfiles/org/netbeans/test/javafx/editor/templates/TemplateTof.pass";
    protected static final String PROJECT_NAME = "TemplateTof";

    public TemplateTof(String name) {
        super(name);
    }

    public static Test suite() {
        return NbModuleSuite.create(TemplateTof.class, ".*", ".*", TESTS);
    }
    ...
    public void testTemplate() {
        ...
        JEditorPaneOperator editor = Util.typeTemplateAtPlaceCodeHere(PROJECT_NAME, SAMPLE_PATH, "tof");
