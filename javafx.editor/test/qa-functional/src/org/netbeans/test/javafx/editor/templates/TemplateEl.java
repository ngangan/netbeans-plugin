...
public class TemplateEl extends JavaFXTestCase {
    ...
    public static String GOLDEN = "goldenfiles/org/netbeans/test/javafx/editor/templates/TemplateEl.pass";
    protected static final String PROJECT_NAME = "TemplateEl";

    public TemplateEl(String name) {
        super(name);
    }

    public static Test suite() {
        return NbModuleSuite.create(TemplateEl.class, ".*", ".*", TESTS);
    }
    ...
    public void testTemplate() {
        ...
        JEditorPaneOperator editor = Util.typeTemplateAtPlaceCodeHere(PROJECT_NAME, SAMPLE_PATH, "el");
