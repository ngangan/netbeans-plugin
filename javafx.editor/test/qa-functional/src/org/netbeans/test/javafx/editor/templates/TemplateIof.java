...
public class TemplateIof extends JavaFXTestCase {
    ...
    public static String GOLDEN = "goldenfiles/org/netbeans/test/javafx/editor/templates/TemplateIof.pass";
    protected static final String PROJECT_NAME = "TemplateIof";

    public TemplateIof(String name) {
        super(name);
    }

    public static Test suite() {
        return NbModuleSuite.create(TemplateIof.class, ".*", ".*", TESTS);
    }
    ...
    public void testTemplate() {
        ...
        JEditorPaneOperator editor = Util.typeTemplateAtPlaceCodeHere(PROJECT_NAME, SAMPLE_PATH, "iof");
