...
public class TemplateRe extends JavaFXTestCase {
    ...
    public static String GOLDEN = "goldenfiles/org/netbeans/test/javafx/editor/templates/TemplateRe.pass";
    protected static final String PROJECT_NAME = "TemplateRe";

    public TemplateRe(String name) {
        super(name);
    }

    public static Test suite() {
        return NbModuleSuite.create(TemplateRe.class, ".*", ".*", TESTS);
    }
    ...
    public void testTemplate() {
        ...
        JEditorPaneOperator editor = Util.typeTemplateAtPlaceCodeHere(PROJECT_NAME, SAMPLE_PATH, "re");
