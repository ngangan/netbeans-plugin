 ...
 * @author David Strupl
 */
public class ThrowEnvironment extends JavaFXCompletionEnvironment<ThrowTree> {
    
    private static final Logger logger = Logger.getLogger(ThrowEnvironment.class.getName());
