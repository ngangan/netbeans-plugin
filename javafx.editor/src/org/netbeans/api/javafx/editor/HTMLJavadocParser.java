...
final class HTMLJavadocParser {
    ...
    private static String getCharSet(ChangedCharSetException e) {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (foundCharSet == false && foundEquals == false && token.equals("charset")) { //NOI18N
                foundCharSet = true;
                continue;
        ...
        class CallbackJavaFX extends HTMLEditorKit.ParserCallback {
            ...
            public void handleStartTag(HTML.Tag t, MutableAttributeSet a, int pos) {
                if (t == HTML.Tag.A && a != null) {
                    final Object idAttr = a.getAttribute(HTML.Attribute.ID); // methods
                    final Object nameAttr = a.getAttribute(HTML.Attribute.NAME); // fields
