 ...
 * @author Michal Skvor
 */
public class Menu implements ActiveEditorDrop {

    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage( Menu.class, "TEMPLATE_Menu" );
        ...
        // Imports
        Util.addImport( targetComponent, "javafx.gui.component.Menu" ); // NOI18N
