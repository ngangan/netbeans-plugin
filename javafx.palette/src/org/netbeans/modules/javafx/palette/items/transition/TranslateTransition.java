...
public class TranslateTransition implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage(TranslateTransition.class, "TEMPLATE_TranslateTransition"); // NOI18N
        ...
        Imports.addImport(targetComponent, "javafx.animation.transition.TranslateTransition"); //NOI18N
