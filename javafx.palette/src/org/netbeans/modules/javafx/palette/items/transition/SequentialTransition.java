...
public class SequentialTransition implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage(SequentialTransition.class, "TEMPLATE_SequentialTransition"); // NOI18N
        ...
        Imports.addImport(targetComponent, "javafx.animation.transition.SequentialTransition"); //NOI18N
