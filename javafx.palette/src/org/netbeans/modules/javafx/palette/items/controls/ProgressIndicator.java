...
public class ProgressIndicator implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage( ProgressIndicator.class, "TEMPLATE_ProgressIndicator" ); // NOI18N
        ...
        // Imports
        Imports.addImport( targetComponent, "javafx.scene.control.ProgressIndicator" ); // NOI18N
