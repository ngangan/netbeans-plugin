...
public class PerspectiveTransform implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage( PerspectiveTransform.class, "TEMPLATE_PerspectiveTransform" );
        ...
        // Imports
        Imports.addImport( targetComponent, "javafx.scene.effect.PerspectiveTransform" ); // NOI18N
