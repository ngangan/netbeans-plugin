...
public class DisplacementMap implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage( DisplacementMap.class, "TEMPLATE_DisplacementMap" );
        ...
        // Imports
        Imports.addImport( targetComponent, "javafx.scene.effect.DisplacementMap" ); // NOI18N
