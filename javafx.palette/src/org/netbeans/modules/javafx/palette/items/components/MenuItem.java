 ...
 * @author Michal Skvor
 */
public class MenuItem implements ActiveEditorDrop {

    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage( MenuItem.class, "TEMPLATE_MenuItem" );
        ...
        // Imports
        Util.addImport( targetComponent, "javafx.gui.component.MenuItem" ); // NOI18N
