...
public class ParallelTransition implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage(ParallelTransition.class, "TEMPLATE_ParallelTransition"); // NOI18N
        ...
        Imports.addImport(targetComponent, "javafx.animation.transition.ParallelTransition"); //NOI18N
