...
public class SwingCheckBox implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage( SwingCheckBox.class, "TEMPLATE_SwingCheckBox" ); // NOI18N
        ...
        // Import
        Imports.addImport( targetComponent, "javafx.ext.swing.SwingCheckBox" ); // NOI18N
