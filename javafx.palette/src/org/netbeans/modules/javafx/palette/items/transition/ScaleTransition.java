...
public class ScaleTransition implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage(ScaleTransition.class, "TEMPLATE_ScaleTransition"); // NOI18N
        ...
        Imports.addImport(targetComponent, "javafx.animation.transition.ScaleTransition"); ////NOI18N
