...
public class Blend implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage( Bloom.class, "TEMPLATE_Blend" );
        ...
        // Imports
        Imports.addImport( targetComponent, "javafx.scene.effect.Blend" ); // NOI18N
        Imports.addImport( targetComponent, "javafx.scene.effect.BlendMode" ); //NOI18N
