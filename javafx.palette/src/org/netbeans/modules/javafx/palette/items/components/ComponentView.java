 ...
 * @author Michal Skvor
 */
public class ComponentView implements ActiveEditorDrop {

    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage( ComponentView.class, "TEMPLATE_ComponentView" );
        ...
        // Imports
        Imports.addImport( targetComponent, "javafx.ext.swing.ComponentView" ); // NOI18N
