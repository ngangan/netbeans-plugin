...
public class FadeTransition implements ActiveEditorDrop {
    ...
    public boolean handleTransfer(JTextComponent targetComponent) {
        String code = NbBundle.getMessage(FadeTransition.class, "TEMPLATE_FadeTransition"); // NOI18N
        ...
        Imports.addImport(targetComponent, "javafx.animation.transition.FadeTransition"); //NOI18N
