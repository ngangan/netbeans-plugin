...
public class SineWave extends JavaFXTestCase {

    public String _type = "Math"; //Type of Sample
    public String _project = "Sine Wave";
    public String _projectPath = "Sine Wave|Source Packages|math|SineWave.fx";
    static String[] TESTS = {"testSineWaveCreate", "testSineWaveCompile", "testSineWaveCloseProject"};
    
    public SineWave (String name) {
        super(name);
    }

    /** Create Sample Project and Verify that Project exists */
    public void testSineWaveCreate() {
    ...
    public void testSineWaveCompile() {
    ...
    public void testSineWaveCloseProject() {
    ...
    public static Test suite() {
        return NbModuleSuite.create(SineWave.class, ".*", ".*", TESTS);
    }
}
