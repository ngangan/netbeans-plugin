...
public class Flocks extends JavaFXTestCase {

    public String _type = "Simulation"; //Type of Sample
    public String _project = "Flock";
    public String _projectPath = "Flock|Source Packages|particles|FlockDemo.fx";
    static String[] TESTS = {"testFlocksCreate", "testFlocksCompile", "testFlocksCloseProject"};
    
    public Flocks (String name) {
        super(name);
    }

    /** Create Sample Project and Verify that Project exists */
    public void testFlocksCreate() {
    ...
    public void testFlocksCloseProject() {
    ...
    public static Test suite() {
        return NbModuleSuite.create(Flocks.class, ".*", ".*", TESTS);
    }
}
