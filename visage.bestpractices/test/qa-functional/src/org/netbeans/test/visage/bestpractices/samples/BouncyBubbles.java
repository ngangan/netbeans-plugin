...
public class BouncyBubbles extends VisageTestCase {
    ...
    static String[] TESTS = {"testBouncyBubblesCreate", "testBouncyBubblesCompile", "testBouncyBubblesCloseProject"};
    ...
    public void testBouncyBubblesCreate() {
    ...
    public void testBouncyBubblesCompile() {
    ...
    public void testBouncyBubblesCloseProject() {
