...
public class Mouse2D extends JavaFXTestCase {
    ...
    static String[] TESTS = {"testMouse2DCreate", "testMouse2DCompile", "testMouse2DCloseProject"};
    ...
    public void testMouse2DCompile() {
    ...
    public void testMouse2DCloseProject() {
