...
public class PointsAndLines extends VisageTestCase {
    ...
    public void testPointsAndLinesCreate() {
    ...
    public void testPointsAndLinesCompile() {
    ...
    public void testPointsAndLinesCloseProject() {
